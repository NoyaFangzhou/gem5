...
alpha_suffix = '_base.newTestAgainnew-m64' 
#temp
#binary_dir = spec_dir
#data_dir = spec_dir
...
perlbench_r.executable =  'perlbench_r' + alpha_suffix
# TEST CMDS
...
roms_r = Process() # Update June 7, 2017: This used to be LiveProcess()
roms_r.executable =  'roms_r' + alpha_suffix
roms_r.cmd = [roms_r.executable] 

fotonik3d_r = Process() # Update June 7, 2017: This used to be LiveProcess()
fotonik3d_r.executable =  'fotonik3d_r' + alpha_suffix
fotonik3d_r.cmd = [fotonik3d_r.executable] 


nab_r = Process() # Update June 7, 2017: This used to be LiveProcess()
nab_r.executable =  'nab_r' + alpha_suffix
nab_r.cmd = [nab_r.executable] 

imagick_r = Process() # Update June 7, 2017: This used to be LiveProcess()
imagick_r.executable =  'imagick_r' + alpha_suffix
imagick_r.cmd = [imagick_r.executable] 

cam4_r = Process() # Update June 7, 2017: This used to be LiveProcess()
cam4_r.executable =  'cam4_r' + alpha_suffix
cam4_r.cmd = [cam4_r.executable] 

wrf_r = Process() # Update June 7, 2017: This used to be LiveProcess()
wrf_r.executable =  'wrf_r' + alpha_suffix
wrf_r.cmd = [wrf_r.executable] 


lbm_r = Process() # Update June 7, 2017: This used to be LiveProcess()
lbm_r.executable =  'lbm_r' + alpha_suffix
lbm_r.cmd = [lbm_r.executable] 

povray_r = Process() # Update June 7, 2017: This used to be LiveProcess()
povray_r.executable =  'povray_r' + alpha_suffix
povray_r.cmd = [povray_r.executable] 

namd_r = Process() # Update June 7, 2017: This used to be LiveProcess()
namd_r.executable =  'namd_r' + alpha_suffix
namd_r.cmd = [namd_r.executable] 


cactuBSSN_r = Process() # Update June 7, 2017: This used to be LiveProcess()
cactuBSSN_r.executable =  'cactuBSSN_r' + alpha_suffix
cactuBSSN_r.cmd = [cactuBSSN_r.executable] 

bwaves_r = Process() # Update June 7, 2017: This used to be LiveProcess()
bwaves_r.executable =  'bwaves_r' + alpha_suffix
bwaves_r.cmd = [bwaves_r.executable] 

blender_r = Process() # Update June 7, 2017: This used to be LiveProcess()
blender_r.executable =  'blender_r' + alpha_suffix
blender_r.cmd = [blender_r.executable] 

parest_r = Process() # Update June 7, 2017: This used to be LiveProcess()
parest_r.executable =  'parest_r' + alpha_suffix
parest_r.cmd = [parest_r.executable] 
    
xz_r = Process() # Update June 7, 2017: This used to be LiveProcess()
xz_r.executable =  'xz_r' + alpha_suffix
xz_r.cmd = [xz_r.executable] 

exchange2_r = Process() # Update June 7, 2017: This used to be LiveProcess()
exchange2_r.executable =  'exchange2_r' + alpha_suffix
exchange2_r.cmd = [exchange2_r.executable] 

leela_r = Process() # Update June 7, 2017: This used to be LiveProcess()
leela_r.executable =  'leela_r' + alpha_suffix
leela_r.cmd = [leela_r.executable] 

deepsjeng_r = Process() # Update June 7, 2017: This used to be LiveProcess()
deepsjeng_r.executable =  'deepsjeng_r' + alpha_suffix
deepsjeng_r.cmd = [deepsjeng_r.executable] 

x264_r = Process() # Update June 7, 2017: This used to be LiveProcess()
x264_r.executable =  'x264_r' + alpha_suffix
x264_r.cmd = [x264_r.executable] 


xalancbmk_r = Process() # Update June 7, 2017: This used to be LiveProcess()
xalancbmk_r.executable =  'xalancbmk_r' + alpha_suffix
xalancbmk_r.cmd = [xalancbmk_r.executable] 


omnetpp_r = Process() # Update June 7, 2017: This used to be LiveProcess()
omnetpp_r.executable =  'omnetpp_r' + alpha_suffix
omnetpp_r.cmd = [omnetpp_r.executable] 

mcf_r = Process() # Update June 7, 2017: This used to be LiveProcess()
mcf_r.executable =  'mcf_r' + alpha_suffix
mcf_r.cmd = [mcf_r.executable] 

gcc_r = Process() # Update June 7, 2017: This used to be LiveProcess()
gcc_r.executable =  'cpugcc_r' + alpha_suffix
gcc_r.cmd = [gcc_r.executable]  + ['166.i', '-o', '166.s'] 


deepsjeng_s = Process() # Update June 7, 2017: This used to be LiveProcess()
deepsjeng_s.executable =  'deepsjeng_s' + alpha_suffix
deepsjeng_s.cmd = [deepsjeng_s.executable] 

omnetpp_s = Process() # Update June 7, 2017: This used to be LiveProcess()
omnetpp_s.executable =  'omnetpp_s' + alpha_suffix
omnetpp_s.cmd = [omnetpp_s.executable] 

lbm_s = Process() # Update June 7, 2017: This used to be LiveProcess()
lbm_s.executable =  'lbm_s' + alpha_suffix
lbm_s.cmd = [lbm_s.executable] 

roms_s = Process() # Update June 7, 2017: This used to be LiveProcess()
roms_s.executable =  'sroms' + alpha_suffix
roms_s.cmd = [roms_s.executable] 


perlbench_s = Process() # Update June 7, 2017: This used to be LiveProcess()
perlbench_s.executable =  'perlbench_s' + alpha_suffix
perlbench_s.cmd = [perlbench_s.executable] 


cam4_s = Process() # Update June 7, 2017: This used to be LiveProcess()
cam4_s.executable =  'cam4_s' + alpha_suffix
cam4_s.cmd = [cam4_s.executable] 

nab_s = Process() # Update June 7, 2017: This used to be LiveProcess()
nab_s.executable =  'nab_s' + alpha_suffix
nab_s.cmd = [nab_s.executable] 


pop2_s = Process() # Update June 7, 2017: This used to be LiveProcess()
pop2_s.executable =  'speed_pop2' + alpha_suffix
pop2_s.cmd = [pop2_s.executable] 

x264_s = Process() # Update June 7, 2017: This used to be LiveProcess()
x264_s.executable =  'x264_s' + alpha_suffix
x264_s.cmd = [x264_s.executable] 

fotonik3d_s = Process() # Update June 7, 2017: This used to be LiveProcess()
fotonik3d_s.executable =  'fotonik3d_s' + alpha_suffix
fotonik3d_s.cmd = [fotonik3d_s.executable] 

gcc_s = Process() # Update June 7, 2017: This used to be LiveProcess()
gcc_s.executable =  'sgcc' + alpha_suffix
gcc_s.cmd = [gcc_s.executable] 


xalancbmk_s = Process() # Update June 7, 2017: This used to be LiveProcess()
xalancbmk_s.executable =  'xalancbmk_s' + alpha_suffix
xalancbmk_s.cmd = [xalancbmk_s.executable] 


xz_s = Process() # Update June 7, 2017: This used to be LiveProcess()
xz_s.executable =  'xz_s' + alpha_suffix
xz_s.cmd = [xz_s.executable] 

mcf_s = Process() # Update June 7, 2017: This used to be LiveProcess()
mcf_s.executable =  'mcf_s' + alpha_suffix
mcf_s.cmd = [mcf_s.executable] 


leela_s = Process() # Update June 7, 2017: This used to be LiveProcess()
leela_s.executable =  'leela_s' + alpha_suffix
leela_s.cmd = [leela_s.executable] 

cactuBSSN_s = Process() # Update June 7, 2017: This used to be LiveProcess()
cactuBSSN_s.executable =  'cactuBSSN_s' + alpha_suffix
cactuBSSN_s.cmd = [cactuBSSN_s.executable] 


imagick_s = Process() # Update June 7, 2017: This used to be LiveProcess()
imagick_s.executable =  'imagick_s' + alpha_suffix
imagick_s.cmd = [imagick_s.executable] 


wrf_s = Process() # Update June 7, 2017: This used to be LiveProcess()
wrf_s.executable =  'wrf_s' + alpha_suffix
wrf_s.cmd = [wrf_s.executable] 


exchange2_s = Process() # Update June 7, 2017: This used to be LiveProcess()
exchange2_s.executable =  'exchange2_s' + alpha_suffix
exchange2_s.cmd = [exchange2_s.executable] 

bwaves_s = Process() # Update June 7, 2017: This used to be LiveProcess()
bwaves_s.executable =  'speed_bwaves' + alpha_suffix
